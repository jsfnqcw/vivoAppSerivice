...
public class Comment {
    ...
    @ResponseBody
    public List<com.nju.second.Model.Comment> getCommentList(@RequestBody @Validated getCommentPojo i, BindingResult bindingResult) {
        int gameid = i.getGameID();
        HttpSession session = request.getSession(false);
        int userid = (int)session.getAttribute("User");
        return cService.getCommentList(gameid);
    }
